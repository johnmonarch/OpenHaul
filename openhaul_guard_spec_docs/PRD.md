...
```bash
curl -fsSL https://openhaulguard.org/install.sh | sh
```
...
Create a project-maintained **OpenHaul Public Mirror**:

```text
https://mirror.openhaulguard.org/
```

or use GitHub Releases / Cloudflare R2:

```text
https://github.com/openhaulguard/data-releases/releases
```
...
Offer a free, rate-limited community API for OSS users:

```text
https://community-api.openhaulguard.org/v1/resolve/mc/123456
```
...
[mirror]
enabled = true
url = "https://mirror.openhaulguard.org"
